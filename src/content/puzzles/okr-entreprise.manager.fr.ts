...
const VARIATION_GOOD: NumericFieldBlock[] = [
  ...
  field("okre-v-good-points", "good", "de [X] points", 1),
  field("okre-v-good-atleast", "good", "d'au moins [X] %", 1),
];
  ...
  return {
    ...
    blocksByCategory: {
      action: [
        ...ACTION_GOOD,
        ...ACTION_NEUTRAL,
        freeCard("okre-a-free", "action"),
        ...ACTION_DISTRACTORS.slice(0, distractorsStandard),
      ],
      indicator: [
        ...INDICATOR_GOOD,
        ...INDICATOR_NEUTRAL,
        freeCard("okre-i-free", "indicator"),
      ...
      timeReference: [
        ...TIMEREF_GOOD,
        ...TIMEREF_NEUTRAL,
        freeCard("okre-t-free", "timeReference"),
