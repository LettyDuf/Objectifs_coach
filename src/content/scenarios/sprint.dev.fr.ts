...
export const SPRINT_DEV_SCENARIOS_FR: ScenarioCard[] = [
  ...
  },
  {
    ...
    type: "sprint",
    audience: "dev",
    teamLabel: "Équipe Search · start-up en adéquation produit-marché",
    iconName: "okr",
    situation:
      "3 devs + 1 référent technique. La recherche actuelle convertit mal (taux clic 12 %). On veut tester l'autocomplétion pour voir si ça monte.",
