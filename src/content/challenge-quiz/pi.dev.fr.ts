 ...
 *
 * Chaque cas cible un piège distinct des objectifs de PI :
...
export const PI_DEV_CHALLENGE_QUIZ_FR: ChallengeQuizCase[] = [
  ...
  // ============================================================
  {
    ...
    iconName: "wrench",
    context:
      "Le train regroupe 4 équipes autour du tunnel d'achat. Le Business Owner pousse pour augmenter les conversions mobile. PI Planning dans deux semaines, objectif à figer en engagé.",
    metrics: [
    ...
    options: [
      ...
      {
        id: "C",
        text: "Augmenter les conversions sur le tunnel mobile.",
        verdict: "partial",
        explanation:
  ...
  // ============================================================
  {
    ...
    iconName: "target",
    context:
      "Le commercial bloque depuis 6 mois sur l'argument SSO chez les grands comptes. Activation SSO aujourd'hui manuelle, 2 semaines par client. PI Planning impose un engagé avec une cible chiffrée.",
    metrics: [
    ...
    options: [
      ...
      {
        id: "D",
        text: "Mettre en place le self-service SSO d'ici la revue de PI.",
        verdict: "bad",
        explanation:
    ...
    options: [
      {
        ...
        verdict: "bad",
        explanation:
          "« Avec succès » est vide. À la revue de PI, deux personnes peuvent défendre des verdicts opposés. Sur un stretch, c'est précisément là où la rigueur de mesure compte.",
      },
      {
        id: "B",
        ...
        verdict: "good",
        explanation:
          "Seuil chiffré (3), bénéficiaire (clients pilotes), fenêtre (revue de PI). Ambitieux pour un stretch (on est à 0 aujourd'hui), mais falsifiable d'un coup d'œil.",
      },
      {
        id: "C",
      ...
      },
      {
        ...
        verdict: "bad",
        explanation:
          "Mesure le travail interne, pas l'adoption. Sur un stretch, l'enjeu est l'apprentissage marché — pas la complétion d'une feuille de route.",
      },
    ],
  },

  // ============================================================
  // Cas 4 — Mot flou alors que la cible existe — engagé
  // ============================================================
  {
    id: "quiz.pi.dev.intégration-scale",
    type: "pi",
    audience: "dev",
    teamLabel: "Train Intégration nouveaux clients · 4 équipes",
    iconName: "practice",
    context:
      "Le taux d'activation des nouveaux comptes stagne à 42 % depuis deux trimestres. Le board demande +20 points sur ce PI. Train coordonné acquisition / produit / support. Cible engagé, confiance équipe estimée à 85 %.",
    metrics: [
  ...
  // ============================================================
  {
    ...
    iconName: "wrench",
    context:
      "La plateforme est victime de son succès. TMR de 45 min, 8 incidents majeurs ce trimestre. Les équipes fonctionnalité passent 30 % de leur temps en astreinte. Objectif stretch ambitieux pour ce PI.",
    metrics: [
      { label: "TMR moyen (PI précédent)", value: "45 min" },
      { label: "Incidents majeurs / trimestre", value: "8" },
      { label: "Temps astreinte des équipes fonctionnalité", value: "30 %" },
    ],
    proposedObjective: "Stabiliser la plateforme et alléger la charge astreinte des équipes fonctionnalité.",
    options: [
      {
        id: "A",
      ...
      {
        id: "B",
        text: "Diviser par 3 le TMR moyen de la plateforme (de 45 min à 15 min) d'ici la revue de PI.",
        verdict: "good",
        explanation:
          "Un seul résultat, métrique nommée, point de départ, cible, fenêtre. Le sujet « charge astreinte » devient un autre objectif de PI du même train, séparé.",
      },
      {
        id: "C",
        text: "Réduire la dette technique de la plateforme, à l'origine de 8 incidents majeurs ce trimestre.",
        verdict: "bad",
        explanation:
      ...
      {
        id: "D",
        text: "Ramener le temps astreinte des équipes fonctionnalité de 30 % à 10 % d'ici la revue de PI.",
        verdict: "partial",
        explanation:
          "Bon outcome, bonne mesure, bonne fenêtre — c'est un objectif de PI valide. Mais c'est la **deuxième moitié** de l'objectif initial. À porter dans un autre objectif de PI du même train, pas en remplacement.",
      },
    ],
  },

  // ============================================================
  // Cas 6 — Variation floue (« de manière notable ») — engagé
  // ============================================================
  {
    ...
    iconName: "target",
    context:
      "Le churn mensuel des comptes premium est passé de 1,8 % à 4 % sur les derniers trimestres. Le board veut un engagé avec cible chiffrée pour ce PI. Confiance équipe estimée à 80 %.",
    metrics: [
    ...
    options: [
      ...
      {
        id: "C",
        text: "Diviser par deux le churn premium d'ici la fin du PI.",
        verdict: "partial",
        explanation:
  ...
  // ============================================================
  {
    ...
    iconName: "okr",
    context:
      "Le train mobile prépare une refonte UX importante. Le Business Owner pousse sur la valeur long terme par utilisateur. PI Planning impose un engagé avec cible mesurable à la revue de PI (8 semaines).",
    metrics: [
    ...
    options: [
      {
        ...
        verdict: "partial",
        explanation:
          "Forme exemplaire (métrique, avant, après) — mais le LTV se calcule sur 12 mois de comportement. À la revue de PI (8 semaines), aucune mesure de LTV ne sera disponible. La cadence de mesure ne tient pas dans la cadence PI.",
      },
      {
        id: "B",
        text: "Faire passer le taux d'engagement à 30 jours des nouveaux utilisateurs mobile de 28 % à 50 % d'ici la revue de PI.",
        verdict: "good",
        explanation:
          "Proxy leading du LTV, observable dans la fenêtre PI. Sous influence directe du train (refonte UX). Mesurable et attribuable à la revue de PI.",
      },
      {
        id: "C",
  ...
  // ============================================================
  {
    ...
    proposedObjective:
      "Permettre aux équipes business de prendre 80 % de leurs décisions via la plateforme analytics d'ici la revue de PI.",
    options: [
      {
        id: "A",
      ...
      {
        id: "D",
        text: "Mettre en place les 12 nouveaux tableaux de bord demandés sur ce PI.",
        verdict: "bad",
        explanation:
  ...
  // ============================================================
  // Cas 9 — Calibrage engagé/stretch incohérent
  // ============================================================
  {
    ...
    proposedObjective:
      "Atteindre 100 % de conformité RGPD sur les traitements de données client d'ici la revue de PI — classé engagé.",
    options: [
      {
        id: "A",
        text: "Atteindre 100 % de conformité RGPD sur les traitements de données client d'ici la revue de PI — classé engagé.",
        verdict: "bad",
        explanation:
          "Calibrage incohérent. Un engagé se vise à 80-100 % de confiance ; ici l'équipe est à 45 %. À la revue de PI, l'objectif ratera l'engagement engagé — perte de crédibilité pour le train.",
      },
      {
        id: "B",
        text: "Atteindre 100 % de conformité RGPD sur les traitements de données client d'ici la revue de PI — classé stretch.",
        verdict: "good",
        explanation:
          "Même cible, classement honnête. Un stretch se vise à 30-60 % de confiance — exactement la situation. À la revue de PI, atteindre 80 % sur un stretch est un vrai succès.",
      },
      {
        id: "C",
        text: "Faire passer le nombre de traitements conformes RGPD de 62 à 122 d'ici la revue de PI — classé engagé.",
        verdict: "partial",
        explanation:
          "Cible chiffrée crédible (≈ doubler), classement engagé cohérent avec une confiance probable >80 %. C'est défendable, mais moins ambitieux que ce que veut le DPO. Selon le contexte stratégique, B (stretch à 100 %) ou C (engagé à 122) peuvent se défendre — le piège est uniquement A (engagé à 100 % avec 45 % de confiance).",
      },
      {
        id: "D",
        ...
        verdict: "bad",
        explanation:
          "Pas de chiffre, pas de seuil, pas de fenêtre. Hors-jeu pour un objectif de PI.",
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    proposedObjective:
      "Atteindre 50 000 visiteurs uniques mensuels sur la marketplace d'ici la revue de PI.",
    options: [
      {
        id: "A",
        text: "Atteindre 50 000 visiteurs uniques mensuels sur la marketplace d'ici la revue de PI.",
        verdict: "partial",
        explanation:
      ...
      {
        id: "B",
        text: "Faire passer le GMV mensuel de la marketplace de 50 k€ à 200 k€ d'ici la revue de PI.",
        verdict: "good",
        explanation:
          "Métrique de fin (valeur économique), point de départ, cible, fenêtre. Aligné avec ce que le board veut voir, mesurable à la revue de PI.",
      },
      {
        id: "C",
        ...
        verdict: "bad",
        explanation:
          "C'est un Objectif qualitatif inspirant, pas un objectif de PI mesurable. Pas de métrique, pas de seuil.",
      },
      {
        id: "D",
        ...
        verdict: "bad",
        explanation:
          "Output. 5 catégories peuvent être lancées sans traction commerciale. L'objectif de PI ne doit pas mesurer le travail interne.",
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    proposedObjective:
      "Faire passer le taux d'inscription depuis la landing page de 4 % à 12 % d'ici la revue de PI.",
    options: [
      {
        id: "A",
        text: "Faire passer le taux d'inscription depuis la landing page de 4 % à 12 % d'ici la revue de PI.",
        verdict: "partial",
        explanation:
          "Forme correcte. Mais isolément, on peut tripler le taux d'inscription en attirant n'importe qui — au prix d'un churn massif derrière. Sans métrique guardrail (qualité), l'objectif de PI peut être atteint en détruisant de la valeur en aval.",
      },
      {
        id: "B",
  ...
  // ============================================================
  // Cas 12 — KR de moyen vs KR de fin (couverture vs TMR)
  // ============================================================
  {
    ...
    iconName: "wrench",
    context:
      "Train Plateforme. objectif de PI autour de la fiabilité. Le SRE pousse pour des indicateurs de mécanique interne (couverture, alerting). Le Business Owner veut des indicateurs perçus par les équipes fonctionnalité consommatrices.",
    metrics: [
      { label: "TMR moyen des incidents plateforme", value: "45 min" },
      { label: "Couverture de tests d'intégration", value: "62 %" },
      { label: "Temps astreinte des équipes fonctionnalité", value: "30 %" },
    ],
    proposedObjective:
      "Atteindre 90 % de couverture de tests d'intégration sur la plateforme d'ici la revue de PI.",
    options: [
      {
        id: "A",
      ...
      {
        id: "C",
        text: "Stabiliser la plateforme et alléger la charge d'astreinte des équipes fonctionnalité.",
        verdict: "bad",
        explanation:
      ...
      {
        id: "D",
        text: "Mettre en place le nouveau système d'alerting sur la plateforme.",
        verdict: "bad",
        explanation:
