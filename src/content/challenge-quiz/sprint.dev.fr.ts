...
export const SPRINT_DEV_CHALLENGE_QUIZ_FR: ChallengeQuizCase[] = [
...

  {
    ...
    iconName: "puzzle",
    context:
      "8 devs, 1 référent technique. L'équipe maintient l'infrastructure consommée par 6 autres équipes fonctionnalité. Migration en cours vers une architecture micro-services.",
    metrics: [
...

  {
    ...
    options: [
      {
        id: "A",
        text: "Livrer les 12 récits du sprint (28 points de vélocité) en respectant la qualité attendue.",
        verdict: "bad",
        explanation:
...

  {
    ...
    iconName: "okr",
    context:
      "3 devs, 1 référent technique. L'équipe travaille sur la recherche d'une plateforme en phase d'adéquation produit-marché. L'équipe veut tester un nouveau modèle d'autocomplétion pour voir s'il améliore l'engagement.",
    metrics: [
    ...
    proposedObjective: "Livrer la v2 de la recherche en autocomplétion.",
    options: [
      {
        id: "A",
  ...
  // ============================================================
  {
    ...
    iconName: "wrench",
    context:
      "4 devs, 1 SRE, 1 référent technique. L'équipe maintient les APIs internes utilisées par les équipes produit. Sprint perf pour préparer une montée en charge prévue dans deux mois.",
    metrics: [
