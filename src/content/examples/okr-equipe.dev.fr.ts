 ...
 *
 * Note : un OKR = un Objectif + 3 à 5 KR. Pour les mauvais exemples qui ciblent
...
export const OKR_EQUIPE_DEV_EXAMPLES_FR: AnnotatedExample[] = [
  ...
  // ============================================================
  {
    ...
    rationale:
      "Objectif qualitatif inspirant. 3 KR chiffrés, outcome, calibrés autour de 60 % (fourchette 50-70 %). Mesures observables côté équipe.",
  },
  {
  ...
  },
  {
    ...
    draft: {
      ...
      isUnderTeamInfluence: true,
      keyResults: [
        { text: "Faire passer le temps moyen d'intégration d'une nouvelle équipe sur notre API de 4 h à 1 h.", confidence: 60 },
  ...
  // ============================================================
  {
    ...
    rationale:
      "L'Objectif porte un chiffre (30 %) — c'est le rôle des KR. En plus, « améliorer » est un mot flou. Reformuler en qualitatif : « Devenir l'outil de référence pour l'observabilité ».",
  ...
  },
  {
    ...
    draft: {
      ...
      isUnderTeamInfluence: true,
      keyResults: [
        { text: "Livrer le nouveau tableau de bord métriques v2 d'ici fin du trimestre.", confidence: 65 },
        { text: "Atteindre 25 équipes actives mensuelles.", confidence: 60 },
        { text: "Faire passer le NPS de 28 à 50.", confidence: 55 },
      ],
    },
    rationale:
      "Le 1er KR est un Résultat clé projet (« Livrer le tableau de bord v2 »). Un KR vise un **changement à atteindre**, pas une livraison. Reformuler : qu'est-ce que le tableau de bord va faire bouger ? Adoption ? Temps gagné ? Incidents évités ?",
    trapWords: ["livrer"],
  ...
  },
  {
    ...
    draft: {
      ...
      keyResults: [
        ...
        { text: "Faire passer le temps d'intégration API de 4 h à 1 h.", confidence: 55 },
  ...
  // Résultat clé » §3, mais n'est PAS représenté ici comme `AnnotatedExample`. Raison :
  ...
  // 100 → contradictoire avec le verdict "bad" et faisait sauter les tests.
  {
    ...
    rationale:
      "L'Objectif contient « et » : il y a deux Objectifs ici (performance et satisfaction). Sépare en deux OKR distincts, chacun avec son propre lot de KR.",
